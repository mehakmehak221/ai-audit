      ...
      <div className="container mx-auto max-w-7xl">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-32">
          ...
          <div className="flex-1 max-w-xl">
            <h2 className="text-5xl md:text-6xl font-bold tracking-tight text-[#162456] mb-6">
              Maxtron <span className="text-[#155DFC]">Audit Flow</span>
            </h2>
            <p className="text-slate-500 font-medium leading-relaxed mb-16 max-w-md">
            ...
            <div className="space-y-6">
              {steps.map((step, idx) => (
                <div 
                  ...
                  className={`cursor-pointer p-8 rounded-[2rem] border transition-all duration-500 flex items-center gap-6 group ${
                    activeStep === idx 
                ...
                >
                  ...
                  <div>
                    <h3 className={`text-xl font-bold transition-colors ${activeStep === idx ? "text-[#162456]" : "text-slate-400"}`}>
                      {step.title}
                    </h3>
          ...
          <div className="flex-1 w-full relative">
            {/* Window Container */}
            <div className="bg-[#0A1022] rounded-[3rem] p-1 shadow-[0_50px_100px_rgba(10,16,34,0.3)] border border-white/5 relative overflow-hidden">
              ...
              <div className="absolute top-8 right-10">
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-white/20">MAXTRON_ENGINE_V4.0</span>
              </div>

          
              <div className="pt-32 pb-24 px-12 flex flex-col items-center text-center">
                
             
                <div className="relative mb-12">
                  <div className="absolute inset-0 bg-blue-600 blur-[60px] opacity-20 scale-150" />
                  <div className="relative h-24 w-24 text-blue-500">
                ...
                <span className="text-[11px] font-black uppercase tracking-[0.3em] text-blue-400 mb-6">{steps[activeStep].status}</span>
                ...
                <div className="mt-20 w-full">
                  <div className="flex justify-between items-end mb-4">
                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-white/20">PROCESSING</span>
                    <span className="text-xs font-black text-white/40">{steps[activeStep].progress}%</span>
                  </div>
            ...
            <div className="absolute -z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[500px] w-[500px] bg-blue-600/10 blur-[120px] rounded-full" />
          </div>
